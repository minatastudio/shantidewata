    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit portlet-form bordered">
            ...
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                <?php
                $getdata = mysqli_query($con, "select * from $tb_category where id = '$_GET[id]'");
                ...
                <form action="<?php echo "$post_url"; ?>" id="form_sample_3" method="post" class="form-horizontal" enctype="multipart/form-data">
                    <div class="form-body">
                        ...
                        if (isset($_POST[submit])) {
                            ...
                            $name = $_POST[name];
                            $insert = edit_1($_POST[id], $name, $_POST[editor1], $file_img, $_POST[imgname], $meta, $tb_category, $con);
                            echo "$insert ";
                            $getdata = mysqli_query($con, "select * from $tb_category where id = '$_GET[id]'");
                            $data = mysqli_fetch_array($getdata, MYSQLI_BOTH);
                            $meta = explode("^", $data[meta]);
