                ...
                <form action="<?php echo "$post_url"; ?>" id="form_sample_3" method="post" class="form-horizontal" enctype="multipart/form-data">
                    <div class="form-body">
                        ...
                        if (isset($_POST[submit])) {
                            ...
                            $name = $_POST[name] . "^" . $_POST[name1] . "^" . $_POST[name2] . "^" . $_POST[name3] . "^" . $_POST[name4];
                        ...
                        <input type="hidden" class="form-control" name="image_data3" value="<?php echo "$imgdata[2]"; ?>">
                        <input type="hidden" class="form-control" name="image_data4" value="<?php echo "$imgdata[3]"; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="col-md-12 noleftpadding">
                                    ...
                                    if ($imgdata[2] != "") {
                                    ?>
                                        <img src="<?php echo "$pathimg_content" . "$imgdata[2]"; ?> " class="img-responsive thumbimg">
                                    <?php } ?>
                                </div>
                                <div class="col-md-6 noleftpadding fileinputres">
                                    <input type="file" name="imgedit3" class="form-control" />
                                </div>
                                <div class="col-md-6 nolrpadding">
                                    <input type="text" name="imgname3" data-required="1" class="form-control" placeholder="Image Name" value="<?php echo "$imgnamedata[2]"; ?>" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="col-md-12 noleftpadding">
                                    ...
                                    if ($imgdata[3] != "") {
                                    ?>
                                        <img src="<?php echo "$pathimg_content" . "$imgdata[3]"; ?> " class="img-responsive thumbimg">
                                    <?php } ?>
                                </div>
                                <div class="col-md-6 noleftpadding fileinputres">
                                    <input type="file" name="imgedit4" class="form-control" />
                                </div>
                                <div class="col-md-6 nolrpadding">
                                    <input type="text" name="imgname4" data-required="1" class="form-control" placeholder="Image Name" value="<?php echo "$imgnamedata[3]"; ?>" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
