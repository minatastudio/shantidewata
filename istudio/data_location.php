                ...
                <div class="portlet-body">
                        ...
                        <div class="row">
                            ...
                            if (isset($_POST[delete])) {
                                for ($i = 1; $i <= $_POST['jum_list']; $i++) {
                                    ...
                                    if ($_POST["checkbox" . "$i"]) {
                                        //echo"$p_code";
                                        $query = mysqli_query($con, "update $tb_location set active = '0' where id = '$p_code'");
                                    }
                                }
                            ?>
                            ...
                            if (isset($_POST[restore])) {
                                for ($i = 1; $i <= $_POST['jum_list']; $i++) {
                                    ...
                                    if ($_POST["checkbox" . "$i"]) {
                                        //echo"$p_code";
                                        $query = mysqli_query($con, "update $tb_location set active = '1' where id = '$p_code'");
                                    }
                                }
                            ?>
                                <div class="alert alert-success "><button class="close" data-close="alert"></button>Data Update successful! </div>
                            ...
                            <div class="col-md-6 col-xs-6">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-primary button-default top-btn-table" onclick="window.location.href = 'page.php?pageid=add_location';"> Add New
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        <tbody>
                            <?php
                            $i = 0;
                            $table = mysqli_query($con, "select * from $tb_location order by name ASC, active DESC");
                            ...
                            ?>
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a href="page.php?pageid=edit_location&&id=<?php echo "$data[id]"; ?>"><i class="icon-note"></i> Edit Data</a>
                                    </td>
                                </tr>
                            <?php } ?>
